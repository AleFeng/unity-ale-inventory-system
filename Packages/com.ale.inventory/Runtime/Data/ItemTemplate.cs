...
namespace Ale.Inventory.Runtime
{
    ...
    public class ItemTemplate : ConfigTemplateBase
    {
        ...
        /// <summary>默认是否禁止丢弃（1.14.0；从模板创建道具时复制，见 <see cref="Item.noDiscard"/>）。</summary>
        ...
        public ItemTemplate Clone()
        {
            ...
            {
                weight = weight, stackLimit = stackLimit, hideInInventory = hideInInventory, noDiscard = noDiscard
            };
